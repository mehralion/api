...
class ApiController extends BaseController
{
	...
	public function inventoryAction()
	{
		...
		try {
			...
			$stmt = $pdo->prepare('select i.id, i.name, i.letter, i.dressed, i.goden, i.dategoden, i.duration, i.maxdur, i.massa, i.includemagic, i.includemagicname, i.includemagicdex, i.includemagicmax, i.includemagicuses from inventory i where i.owner = :owner and i.setsale = 0');
